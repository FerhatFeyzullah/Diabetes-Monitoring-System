...
namespace DiabetesMonitoringSystem.Persistence.Migrations
{
    ...
    [Migration("20250620115508_mig_appuser_edit_tc_and_gendertype_and_add_doctorid")]
    partial class mig_appuser_edit_tc_and_gendertype_and_add_doctorid
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("DiabetesMonitoringSystem.Domain.Entities.Message", b =>
                {
                    b.Property<int>("MessageId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("DiabetesMonitoringSystem.Domain.Entities.PatientSymptom", b =>
                {
                    b.Property<int>("PatientSymptomId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");

                    NpgsqlPropertyBuilderExtensions.UseIdentityByDefaultColumn(b.Property<int>("PatientSymptomId"));
            ...
            modelBuilder.Entity("DiabetesMonitoringSystem.Domain.Entities.Alert", b =>
                {
                    b.HasOne("DiabetesMonitoringSystem.Domain.Entities.Message", "Message")
                        .WithMany()
            ...
            modelBuilder.Entity("DiabetesMonitoringSystem.Domain.Entities.PatientSymptom", b =>
                {
                    ...
                    b.HasOne("DiabetesMonitoringSystem.Domain.Entities.Symptom", "Symptom")
                        .WithMany()
